...
export const AchievementDescriptions: Record<Achievements, string> = {
  ...
  [Achievements.REJECTED_BUT_NOT_DEJECTED]: 'Declined today, buddies tomorrow?',
  [Achievements.BREAKING_THE_PADDLE_BOND]: "It's not you, it's me... ",
  [Achievements.PONG_MASTER]: 'My name is Pong, James Pong',
  [Achievements.THE_STYLISH_ONE]:
    "Embracing the spirit of 'losing like a pro', you've weathered 5 defeats with style",
