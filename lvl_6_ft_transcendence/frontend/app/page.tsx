	...
	return (
		<div className='flex flex-col items-center'>
			...
			<div className='w-full h-max flex place-content-end px-12 text-2xl space-x-4'>
				...
				/>
				<a href={"https://api.intra.42.fr/oauth/authorize?client_id=u-s4t2ud-b5dc96e149f80b24df624871658fdaa8d6610f1efc0a284afab94cbdb7d0420c&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Flogin&response_type=code"} className='h-auto w-10 flex group'>
